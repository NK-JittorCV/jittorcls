...
from jvcore.layers import DropPath, to_2tuple, trunc_normal_
...
def checkpoint_filter_fn(state_dict, patch_size=16):
...
def _create_van(variant, pretrained=False, default_cfg=None, **kwargs):
...
def van_tiny(pretrained=False, **kwargs):
    model_kwargs = dict(
        ...
        norm_layer=nn.LayerNorm, depths=[3, 3, 5, 2], **kwargs)
    return _create_van('van_tiny', pretrained=pretrained, **model_kwargs)
...
def van_small(pretrained=False, **kwargs):
    model_kwargs = dict(
        ...
        norm_layer=nn.LayerNorm, depths=[2, 2, 4, 2], **kwargs)
    return _create_van('van_tiny', pretrained=pretrained, **model_kwargs)
...
def van_base(pretrained=False, **kwargs):
    model_kwargs = dict(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4], 
        norm_layer=nn.LayerNorm, depths=[3, 3, 12, 3],  **kwargs)
    return _create_van('van_tiny', pretrained=pretrained, **model_kwargs)
...
def van_large(pretrained=False, **kwargs):
    model_kwargs = dict(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4], 
        norm_layer=nn.LayerNorm, depths=[3, 5, 27, 3],   **kwargs)
    return _create_van('van_tiny', pretrained=pretrained, **model_kwargs)
